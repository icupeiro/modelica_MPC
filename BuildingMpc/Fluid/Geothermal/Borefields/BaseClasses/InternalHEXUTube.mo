...
model InternalHEXUTube
  ...
  extends IBPSA.Fluid.Interfaces.FourPortHeatMassExchanger(
    ...
    T1_start=T_start,
    T2_start=T_start,
    final tau1=Modelica.Constants.pi*borFieDat.conDat.rTub^2*hSeg*rho1_nominal/
        m1_flow_nominal,
    final tau2=Modelica.Constants.pi*borFieDat.conDat.rTub^2*hSeg*rho2_nominal/
        m2_flow_nominal,
    final vol1(
  ...
  IBPSA.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesOneUTube
    ...
    borFieDat=borFieDat,
    hSeg=hSeg) "Internal resistances for a single U-tube configuration"
...
protected
 ...
 parameter Real Rgb_val = (1 - x)*Rg
  ...
  parameter Real RCondGro_val =  x*Rg + RCondPipe/hSeg
  ...
  // Help variables
  parameter Real sigma= (borFieDat.filDat.kFil - borFieDat.soiDat.kSoi)/(borFieDat.filDat.kFil + borFieDat.soiDat.kSoi);
  ...
  parameter Real RConv = BuildingMpc.Fluid.Geothermal.Borefields.BaseClasses.convectionResistance(
            hSeg=hSeg,
            rBor=borFieDat.conDat.rBor,
            rTub=borFieDat.conDat.rTub,
            eTub=borFieDat.conDat.eTub,
  ...
  parameter Real beta= 2*Modelica.Constants.pi*borFieDat.filDat.kFil*(RCondPipe+RConv);

  parameter Real R_1delta_LS= 1/(2*Modelica.Constants.pi*borFieDat.filDat.kFil)*(log(borFieDat.conDat.rBor/borFieDat.conDat.rTub) + log(borFieDat.conDat.rBor/(2*borFieDat.conDat.xC)) +
    sigma*log(borFieDat.conDat.rBor^4/(borFieDat.conDat.rBor^4 - borFieDat.conDat.xC^4))) + RCondPipe + RConv;

  parameter Real R_1delta_MP= R_1delta_LS - 1/(2*Modelica.Constants.pi*borFieDat.filDat.kFil)*(borFieDat.conDat.rTub^2/
  ...
  parameter Real Ra_LS =     1/(Modelica.Constants.pi*borFieDat.filDat.kFil)*(log(2*borFieDat.conDat.xC/borFieDat.conDat.rTub) + sigma*log((
  ...
  parameter Real Ra= Ra_LS - 1/(Modelica.Constants.pi*borFieDat.filDat.kFil)*(borFieDat.conDat.rTub^2/(4*borFieDat.conDat.xC^2)*(1 + sigma*
  ...
  parameter Real Rg = (2*Rb_internal-RCondPipe-RConv)/hSeg;
