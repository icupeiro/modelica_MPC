...
expandable connector InputBus
  ...
  //input Modelica.SIunits.HeatFlowRate Qbor(start = 100);
  //
  input Modelica.SIunits.Temperature Tin(start = 273.15+13.5);
  //input Modelica.SIunits.MassFlowRate mFlow(start=0.1);
