...
public
  ...
  IDEAS.Fluid.FixedResistances.Junction jun1(
    ...
    dp_nominal={0,0,0}) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={42,-36})));
  Modelica.Blocks.Sources.RealExpression optVar4(y=0)
...
equation
  ...
  connect(embeddedPipe.port_b, TCon.port_a)
    annotation (Line(points={{-8,-36},{4,-36}},  color={0,127,255}));
  ...
  connect(presTem.y, auxHeaSystem.Q_flow)
    annotation (Line(points={{21,32},{12,32}}, color={0,0,127}));
  ...
  connect(borFie_pump.port_b, threeWayValveSwitch1.port_b)
    annotation (Line(points={{72,82},{92,82},{92,52}}, color={0,127,255}));
  connect(threeWayValveSwitch1.port_a1, heaPum.port_a2)
    annotation (Line(points={{92,32},{92,-24},{72,-24}}, color={0,127,255}));
  connect(threeWayValveSwitch1.port_a2, hex.port_a2)
    annotation (Line(points={{82,42},{76,42}}, color={0,127,255}));
  connect(heaPum.port_b2, jun.port_1)
    annotation (Line(points={{52,-24},{46,-24},{46,38}}, color={0,127,255}));
  connect(jun.port_2, TIn.port_a)
    annotation (Line(points={{46,46},{46,52},{10,52}}, color={0,127,255}));
  connect(jun.port_3, hex.port_b2) annotation (Line(points={{50,42},{54,42},{54,
          42},{56,42}}, color={0,127,255}));
  connect(hex.port_b1, threeWayValveSwitch.port_a2) annotation (Line(points={{
          76,30},{82,30},{82,-18},{44,-18},{44,-68}}, color={0,127,255}));
  connect(TCon.port_b, jun1.port_1)
    annotation (Line(points={{24,-36},{38,-36}}, color={0,127,255}));
  connect(jun1.port_2, heaPum.port_a1)
    annotation (Line(points={{46,-36},{52,-36}}, color={0,127,255}));
