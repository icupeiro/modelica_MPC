...
public
  ...
  Modelica.Blocks.Sources.RealExpression TRet(y=0)
...
equation
  ...
  connect(TRet.y, source.T_in) annotation (Line(points={{-71,60},{-58,60},{-58,
  ...
  connect(rectangularZoneTemplate.gainCon, airSystem.port) annotation (Line(
        points={{-36,-13},{-24,-13},{-24,0},{-10,0}}, color={191,0,0}));
