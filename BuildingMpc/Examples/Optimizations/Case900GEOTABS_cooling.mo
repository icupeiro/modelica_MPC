...
model Case900GEOTABS_cooling
  ...
  Modelica.Blocks.Sources.RealExpression optVar1(y=mpcCase900GEOTABS_cooling.yOpt[
  ...
  IBPSA.Fluid.Sources.Boundary_pT source(
    ...
    nPorts=1) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-36,70})));
  Modelica.Blocks.Sources.RealExpression optVar3(y=mpcCase900GEOTABS_cooling.yOpt[
...
public
  Modelica.Blocks.Sources.RealExpression optVar2(y=mpcCase900GEOTABS_cooling.yOpt[
  ...
  MPCs.MpcCase900GEOTABS_cooling
                         mpcCase900GEOTABS_cooling(stateEstimationType=
  ...
  Modelica.Blocks.Sources.RealExpression optVar4(y=if mpcCase900GEOTABS_cooling.yOpt[
        4] < 0.8 then 0 else 1)
...
for i in 1:31 loop
  mpcCase900GEOTABS_cooling.uSta[i] = simState[i];
end for;

// for i in 32:mpcCase900GEOTABS_cooling.nSta loop
//   mpcCase900GEOTABS_cooling.uSta[i] = -99999;
// end for;
